...
set "file_list_to_chg=(org\pentaho\platform\web\http\ConfigurationAdminNonOsgiProxy org\pentaho\platform\web\http\api\resources\FileResource )"
set "file_list_to_add=()"
